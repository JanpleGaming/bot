...
[![Discord Bots](https://discordbots.org/api/widget/272794933176565761.svg)](https://discordbots.org/bot/272794933176565761)

## indev-4.0.2
This branch, against all odds, tracks a rewrite of GAB that will ultimately lead to GAB v4.1.
You can contribute by opening pull requests as long as your commits follow our [eslint rules](https://github.com/GilbertGobbels/GAwesomeBot/blob/development/.eslintrc.json). Remember that this version is in development, and as such code or features currently in the repo are unstable and may be modified and/or removed at any time in the future. To keep track of development, check out [the 4.1 Trello board](https://trello.com/b/yrHdxaik/gab-41).
